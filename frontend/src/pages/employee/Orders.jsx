...
const Orders = () => {
    ...
    const fetchOrders = useCallback(async () => {
        try {
            ...
            const response = await employeeAPI.getOrders(params);
    ...
    const handleStatusUpdate = async (orderId, newStatus) => {
        try {
            ...
            await employeeAPI.updateOrderStatus(orderId, { orderStatus: newStatus });
                                    ...
                                    <div className="space-y-3 flex-1">
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm font-medium">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-text-primary">{order.items?.length || 0} Books</p>
                                            </div>
                                            <div>
