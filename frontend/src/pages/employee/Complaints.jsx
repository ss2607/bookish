                                    ...
                                    <div className="p-6">
                                        <div className="flex flex-col lg:flex-row justify-between gap-4 mb-4">
                                            ...
                                            <div className="flex items-center gap-2">
                                                {!complaint.assignedTo && complaint.status !== 'resolved' && complaint.status !== 'escalated' && (
                                                    <Button variant="outline" size="sm" onClick={() => handleClaim(complaint._id)}>Claim</Button>
                                                )}
                                                {complaint.status !== 'resolved' && complaint.status !== 'escalated' && (
                                                    <Button variant="outline" size="sm" onClick={() => handleEscalate(complaint._id)}>Escalate</Button>
                                                )}
