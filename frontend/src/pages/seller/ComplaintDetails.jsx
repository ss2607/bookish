...
const ComplaintDetails = () => {
  ...
  const fetchComplaintDetails = async () => {
    try {
      setLoading(true);
      const response = await api.get(`/seller/complaints/${id}`);
  ...
  const handleAddComment = async (e) => {
    ...
    try {
      setSubmitting(true);
      const response = await api.post(`/seller/complaints/${id}/comment`, {
            ...
            <Card>
              <Card.Body>
                <div className="text-center py-8">
                  ...
                  <Button variant="primary" onClick={() => navigate('/seller/complaints')}>
                    View All Complaints
                  </Button>
                </div>
              </Card.Body>
